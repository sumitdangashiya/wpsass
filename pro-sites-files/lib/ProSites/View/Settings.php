...
//			$levels = (array) get_site_option( 'psts_levels' );
			...
			<div class="inside">
				<table class="form-table">
					<tr valign="top">
						<th scope="row"
						    class="psts-help-div psts-rebrand-pro"><?php echo __( 'Rebrand WPSAAS', 'psts' ) . ProSites_Helper_UI::help_text( __( 'Rename "WPSAAS" for users to whatever you want like "Pro" or "Plus".', 'psts' ) ); ?></th>
						<td>
					...
					<tr valign="top">
						...
						<td>
							<label><input type="checkbox" name="psts[hide_adminmenu]"
								...
								<?php _e( 'Remove the WPSAAS upgrade menu item', 'psts' ); ?></label>
						</td>
					</tr>
					<tr valign="top">
						...
						<td>
							<label><input type="checkbox" name="psts[hide_adminbar]"
								...
								<?php _e( 'Remove the WPSAAS upgrade menu button from the admin bar', 'psts' ); ?>
							</label>
						</td>
					</tr>
					<tr valign="top">
						...
						<td>
							<label><input type="checkbox" name="psts[hide_adminbar_super]"
								...
								<?php _e( 'Remove the Super Admin WPSAAS status menu from the admin bar', 'psts' ); ?>
							</label>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row"
						    class="psts-help-div force-redirect-expiraton"><?php echo __( 'Force redirect on Expiration', 'psts' ) . ProSites_Helper_UI::help_text( __( 'Redirect site admin to Checkout page, on WPSAAS expiration', 'psts' ), 'force-redirect' ); ?></th>
						<td>
					...
					<tr valign="top">
						<th scope="row"
						    class="psts-free-level psts-help-div"><?php echo __( 'Free Level', 'psts' ) . ProSites_Helper_UI::help_text( __( 'WPSAAS has a built-in free level by default. Configure how this level is displayed on the checkout form:', 'psts' ) ); ?></th>
						<td>
							<label>
					...
					<tr valign="top">
						<th scope="row"
						    class="free-signup"><?php echo __( 'Allow Free Signup<br /><small>* Signup on Checkout</small>', 'psts' ) . ProSites_Helper_UI::help_text( __( 'Allow user to sign up for a standard non-WPSAAS blog.', 'psts' ) ); ?></th>
						<td>
					...
					<tr valign="top">
						<th scope="row"
						    class="psts-help-div psts-feature-message"><?php echo __( 'WPSAAS Feature Message', 'psts' ) . ProSites_Helper_UI::help_text( __( 'Required - No HTML - This message is displayed when a feature is accessed on a site that does not have access to it. "LEVEL" will be replaced with the needed level name for the feature.', 'psts' ) ); ?></th>
						<td>
		...
		public static function render_tab_email() {
			...
			<div class="inside">
				<table class="form-table">
					<tr>
						<th scope="row"
						    class="psts-help-div psts-pro-signup"><?php echo __( 'WPSAAS Signup', 'psts' ) . ProSites_Helper_UI::help_text( __( 'WPSAAS signup confirmation email sent to user', 'psts' ) ); ?></th>
						<td>
					...
					<tr>
						<th scope="row"
						    class="psts-help-div psts-pro-site-cancelled"><?php echo __( 'WPSAAS Canceled', 'psts' ) . ProSites_Helper_UI::help_text( __( 'Membership cancellation email sent to user, "ENDDATE" will be replaced with the date when their WPSAAS access ends.', 'psts' ) ); ?></th>
						<td>
							<label><?php _e( 'Subject:', 'psts' ); ?><br/>
					...
					<tr>
						<th scope="row"
						    class="psts-help-div psts-expiration-mail"><?php echo __( 'Expiration Email', 'psts' ) . ProSites_Helper_UI::help_text( __( 'WPSAAS expiration email sent to user. "CHECKOUTURL" will be replaced with the url to upgrade the site.', 'psts' ) ); ?></th>
						<td>
							<label><?php _e( 'Subject:', 'psts' ); ?><br/>
					...
					<tr>
						<th scope="row"
						    class="psts-help-div psts-pro-manual-extension"><?php echo __( 'WPSAAS Manual Extension', 'psts' ) . ProSites_Helper_UI::help_text( __( 'WPSAAS email sent to user when site is manually extended.', 'psts' ) ); ?></th>
						<td>
							<label><?php _e( 'Subject:', 'psts' ); ?><br/>
					...
					<tr>
						<th scope="row"
						    class="psts-help-div psts-pro-permanent-revoked"><?php echo __( 'WPSAAS Permanent Status Revoked', 'psts' ) . ProSites_Helper_UI::help_text( __( 'WPSAAS email sent to user when the permanent status has been revoked.', 'psts' ) ); ?></th>
						<td>
							<label><?php _e( 'Subject:', 'psts' ); ?><br/>
