...
if ( ! class_exists( 'ProSites_View_Pricing' ) ) {
	class ProSites_View_Pricing {
		...
		public static function get_page_name() {
			return __( 'WPSAAS Pricing Table', 'psts' );
		}
			...
			<table class="form-table">
				...
				<tr>
					<th scope="row"><?php _e( 'Level Order', 'psts' ) ?>
						<br/><span class="description"
						           style="font-weight:normal; color:#888; "><?php _e( 'Select the order that you want your levels to appear in the pricing and feature tables.', 'psts' ) ?></span>
					</th>
					<td>
		...
		public static function render_tab_comparison_table() {
			...
			<table class="form-table">
				...
				<tr id="module-comparison-table">
					<td colspan="2">
						<div
							class="form-description"><?php _e( 'Use the form below to build your feature comparison table.', 'psts' ); ?></div>
